...
export function About() {
  ...
  return (
    <section id="about" className="relative py-20 nexus-surface-variant/30">
      ...
      <div className=" px-4 sm:px-6 lg:px-8">
        ...
        <div className="container mx-auto text-justify text-md md:text-lg mb-16">
          ...
          <p className="nexus-text-secondary mb-4">
          ...
          <span className="nexus-gradient-text font-semibold">Invest in Africa Dreams.</span>
        </div>

        <div className="grid container mx-auto grid-cols-1 lg:grid-cols-2 gap-12 text-justify items-center mb-16">
          <div>
            <h3 className="text-2xl font-bold mb-6 nexus-text">Notre Mission</h3>
            <p className="nexus-text-secondary mb-6 leading-relaxed">
            ...
            <p className="nexus-text-secondary leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-6">
            <button
              ...
              className="text-center p-6 nexus-card hover:nexus-border-variant hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 cursor-pointer group"
            >
              <div className="flex justify-center mb-4">
                <div className="p-3 bg-gradient-to-r from-[hsl(var(--nexus-primary))]/10 to-[hsl(var(--nexus-secondary))]/10 rounded-full group-hover:from-[hsl(var(--nexus-primary))]/20 group-hover:to-[hsl(var(--nexus-secondary))]/20 transition-all duration-300">
                  <Rocket className="h-8 w-8 text-[hsl(var(--nexus-primary))] group-hover:scale-110 transition-transform" />
                </div>
              </div>
              <h4 className="font-semibold mb-2 nexus-text">Startups</h4>
              <p className="text-sm nexus-text-secondary">Investissement dans l'innovation</p>
            </button>
            <button
            ...
            >
              <div className="flex justify-center mb-4">
                <div className="p-3 bg-gradient-to-r from-[hsl(var(--nexus-primary))]/10 to-[hsl(var(--nexus-secondary))]/10 rounded-full group-hover:from-[hsl(var(--nexus-primary))]/20 group-hover:to-[hsl(var(--nexus-secondary))]/20 transition-all duration-300">
                  <LineChart className="h-8 w-8 text-[hsl(var(--nexus-primary))] group-hover:scale-110 transition-transform" />
                </div>
              </div>
              <h4 className="font-semibold mb-2 nexus-text">Bourse</h4>
              <p className="text-sm nexus-text-secondary">Trading et investissement</p>
            </button>
            <button
            ...
            >
              <div className="flex justify-center mb-4">
                <div className="p-3 bg-gradient-to-r from-[hsl(var(--nexus-primary))]/10 to-[hsl(var(--nexus-secondary))]/10 rounded-full group-hover:from-[hsl(var(--nexus-primary))]/20 group-hover:to-[hsl(var(--nexus-secondary))]/20 transition-all duration-300">
                  <Building2 className="h-8 w-8 text-[hsl(var(--nexus-secondary))] group-hover:scale-110 transition-transform" />
                </div>
              </div>
              <h4 className="font-semibold mb-2 nexus-text">Entreprises</h4>
              <p className="text-sm nexus-text-secondary">Acquisitions stratégiques</p>
            </button>
            <button
            ...
            >
              <div className="flex justify-center mb-4">
                <div className="p-3 bg-gradient-to-r from-[hsl(var(--nexus-primary))]/10 to-[hsl(var(--nexus-secondary))]/10 rounded-full group-hover:from-[hsl(var(--nexus-primary))]/20 group-hover:to-[hsl(var(--nexus-secondary))]/20 transition-all duration-300">
                  <Shield className="h-8 w-8 text-[hsl(var(--nexus-primary))] group-hover:scale-110 transition-transform" />
                </div>
              </div>
              <h4 className="font-semibold mb-2 nexus-text">Sécurité</h4>
              <p className="text-sm nexus-text-secondary">Gestion des risques</p>
            </button>
          </div>
        </div>
        ...
        <div className="text-center grid container mx-auto bg-gradient-to-r from-[hsl(var(--nexus-primary))]/10 to-[hsl(var(--nexus-secondary))]/10 rounded-2xl p-8 nexus-border-variant border">
          <h3 className="text-2xl font-bold mb-4 nexus-text">Nos Valeurs</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="font-semibold mb-2 text-[hsl(var(--nexus-primary))]">Excellence</h4>
              <p className="text-sm nexus-text-secondary">Nous visons l'excellence dans chaque investissement</p>
            </div>
            <div>
              <h4 className="font-semibold mb-2 text-[hsl(var(--nexus-primary))]">Transparence</h4>
              <p className="text-sm nexus-text-secondary">Communication claire et honnête avec nos membres</p>
            </div>
            <div>
              <h4 className="font-semibold mb-2 text-[hsl(var(--nexus-secondary))]">Innovation</h4>
              <p className="text-sm nexus-text-secondary">Adoption des dernières technologies et stratégies</p>
            </div>
          </div>
        </div>
      </div>
